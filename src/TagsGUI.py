...
class MusicTagsApp:
    def __init__(self, root):
        ...
        self.root.iconbitmap(default=os.path.join(application_path, 'rekordbox.ico'))
    ...
    def create_file_selectors(self):
        ...
        self.use_rekordbox_checkbox.grid(row=3, column=0, columnspan=3, padx=10, pady=5)
    ...
    def run_script(self):
        ...
        def thread_func():
            try:
                ...
                result = subprocess.run(['python', 'mytag_converter.py'], capture_output=True, text=True)
